...
(X_treinamento, y_treinamento), (X_teste, y_teste) =  cifar10.load_data() #Divide a databse
#plt.imshow(X_treinamento[5000], cmap = 'grey')
...
classificador = Sequential([ #Primeira camada é o operador de convolução
    tf.keras.layers.Conv2D(32, (3, 3), input_shape=(32, 32, 3), activation = 'relu'), #numero mapas, kernel_size, dimensões da imagem
